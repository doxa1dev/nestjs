...
import { AwsFileInfo } from 'lib/aws/dto/aws-file-info.dto';
import { AwsBucketAction } from 'lib/aws/enum/aws-bucket-action.enum';
import { StorageFolderNameEnum } from 'lib/aws/enum/storage-folder-name.enum';
